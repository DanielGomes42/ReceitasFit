...
const recipeExample: Recipe[] = [
  {
    ...
    modoPreparo: [
      'a coxinha de frango é muito popular e tradicional. Nessa receita você vai ver que é simples e delicioso fazer essa receita em casa, vale a pena tentar.',
      '2 - Misture e reserve.',
  ...
  {
    id: 6,
    nomeReceita: 'Crepioca de frango cremoso',
    itensFaltantes: [
      '50 g farinha de milho fina',
      '10 g de cacau em pó',
      '250 g de chocolate meio amargo',
