...
export function Home() {
  ...
  function searchForRecipesWithTheseItems() {
    ...
    recipeService
      .searchRecipes(selectedQuantityItems)
      .then(res => {
  ...
  return (
    <View style={styles.container}>
        ...
        {ITENS_CATEGORY_LIST.map(item => {
          return (
            <CategoryCard
              ...
              onPress={() =>
                handleSelectCategoryAndOpenActionSheet(item.category)
              }
            />
          );
        })}
        ...
        ListEmptyComponent={
          <View style={styles.emptyFlatList}>
            <Typography textColor="red">
              Para usar basta escolher uma categoria. E selecionar os itens que
      ...
      >
        <Typography>Buscar receitas</Typography>
      </Button>
